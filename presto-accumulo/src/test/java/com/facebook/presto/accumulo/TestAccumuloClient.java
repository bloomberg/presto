...
public class TestAccumuloClient
{
            ...
            throws Exception
    {
        ...
        client = new AccumuloClient(connector, config, zooKeeperMetadataManager, new AccumuloTableManager(connector), new TestingNodeManager(), new TabletSplitGenerationMachine(config, connector, new ColumnCardinalityCache(config)));
    }
